    ...
    return (
        <div className='bg-slate-50 grainy-light'>
                    ...
                    <div className='col-span-2 px-6 lg:px-0 lg:pt-4'>
                        <div
                            ...
                            <div className='absolute w-28 left-0 -top-20 hidden lg:block'>
                                ...
                                <img src='/duck-1.png' className='w-full h-36 object-cover'/>
                            </div>
                            <h1 className='relative w-fit tracking-tight text-balance mt-16 font-bold !leading-tight text-gray-900 text-5xl md:text-6xl lg:text-7xl'>
                                Your Image on a{' '}
                                <span className='bg-yellow-600 px-2 text-white'>Custom</span>{' '}
                                Phone Case
                            </h1>
                            ...
                            <ul className='mt-8 space-y-2 text-left font-medium flex flex-col items-center sm:items-start'>
                                <div className='space-y-2'>
                                    ...
                                    <li className='flex gap-1.5 items-center text-left'>
                                        <Check className='h-5 w-5 shrink-0 text-yellow-600'/>5 year
                                        print guarantee
                                    </li>
                                    <li className='flex gap-1.5 items-center text-left'>
                                        <Check className='h-5 w-5 shrink-0 text-yellow-600'/>
            ...
            <section className='bg-slate-100 grainy-dark py-24'>
                ...
                customers{' '}
                                <Icons.underline
                                    className='hidden sm:block pointer-events-none absolute inset-x-0 -bottom-6 text-yellow-500'/>
              </span>{' '}
                            say
                        </h2>
                    ...
                    <div className='mb-12 px-6 lg:px-8'>
                        <div className='mx-auto max-w-2xl sm:text-center'>
                            <h2 className='order-1 mt-2 tracking-tight text-center text-balance !leading-tight font-bold text-5xl md:text-6xl text-gray-900'>
                                ...
                                <span className='relative px-2 bg-yellow-600 text-white'>
                  your own case
                </span>{' '}
                                now
                            </h2>
                    ...
                    <ul className='mx-auto mt-12 max-w-prose sm:text-lg space-y-2 w-fit'>
                        <li className='w-fit'>
                            <Check className='h-5 w-5 text-yellow-600 inline mr-1.5'/>
                        ...
                        <li className='w-fit'>
                            <Check className='h-5 w-5 text-yellow-600 inline mr-1.5'/>5 year
                            print warranty
                        </li>
